...
import { createExpenseHandler, deleteExpenseHandler, expenseSummaryHandler, listExpensesHandler, updateExpenseHandler } from "./controller.js"

// Branch cash-expense tracking — a branch_user manages their own branch's entries, a super_admin
// can see/manage across every branch. No reason for customer/delivery_boy accounts to reach this.
export async function expensesRoutes(fastify: FastifyInstance): Promise<void> {
  ...
  fastify.get("/", listExpensesHandler)
