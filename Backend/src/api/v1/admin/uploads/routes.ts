...
import { bulkUploadFileHandler, listImportBatchesHandler, revertImportBatchHandler, uploadCycleStatusHandler, uploadFileHandler } from "./controller.js"
...
export async function uploadsRoutes(fastify: FastifyInstance): Promise<void> {
  ...
  fastify.delete("/:id", { preHandler: [requireAuth, requireRole(SystemRoleCode.SUPER_ADMIN)] }, revertImportBatchHandler)
}
